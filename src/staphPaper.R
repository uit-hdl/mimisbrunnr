...
source( paste0(MAIN_CODE_FOLDER,"lib/analysis.R"),               encoding="utf-8")
source( paste0(MAIN_CODE_FOLDER,"lib/tools/toolsNetworks.R"),    encoding="utf-8")
source( paste0(MAIN_CODE_FOLDER,"lib/tools/toolsPlotting.R"),    encoding="utf-8")
source( paste0(MAIN_CODE_FOLDER,"lib/tools/toolsSummarizers.R"), encoding="utf-8")
source( paste0(MAIN_CODE_FOLDER,"indexesV2.R"),                  encoding="utf-8")
...
# ------------------------------------------------------------------------------
{
    ...
    xi2SummaryDF = simpleXi(completeTable, explanatoryIndexes, consequenceIndexes)
    ...
    xi2SummaryHDF = simpleXi(womenMenstruatingTable, hormonalIndex, consequenceIndexes)
...
# ------------------------------------------------------------------------------
{
    ...
    # so we are summarizing the most prevalent spa-types in one table only
    {
        ...
        doBarPlot(tempTable, spaT1IndexComplete, AUREUS_FOLDER ,
                  showNumbers  = TRUE, cropNumbers  = 0,
                  sort = "ascending", plotRotate = TRUE,
                  plotTitle = "Old", overrideTableName = "OldTable",
        ...
        doBarPlot(tempTable, spaT1IndexComplete, AUREUS_FOLDER ,
                  showNumbers  = TRUE, cropNumbers  = 0,
                  sort = "ascending", plotRotate = TRUE,
                  plotTitle = "New1", overrideTableName = "New1Table",
                  overrideImageWidth = 8, overrideImageHeight = 8)
        ...
        tempTable = tempTable[tempTable[,spaT1IndexComplete] %in% spaTargetModalitiesColonizedThroat$Modality,]
        doBarPlot(tempTable, spaT1IndexComplete, AUREUS_FOLDER ,
                  showNumbers  = TRUE, cropNumbers  = 0,
                  sort = "ascending", plotRotate = TRUE,
                  plotTitle = "New2", overrideTableName = "New2Table",
                  overrideImageWidth = 8, overrideImageHeight = 8)
...
# ------------------------------------------------------------------------------
{
    ...
    # Figure for the overall network with the Enrichment Carrier
    {
        ...
        doGraphPlot(overallEdgesDF,  completeTable, PAPER_FOLDER,
                    ...
                    overrideLegendPosition = c(0.8, 0.2)) 
...
# ------------------------------------------------------------------------------
{
    ...
    # Now the logistic regression model and plot
    {
        ...
        DPositiveFriendsPvalue  = myBoxplotResults[[2]][2,2]
        DNegativeFriendsAverage = myBoxplotResults[[3]][2,1]
        DPositiveFriendsAverage = myBoxplotResults[[3]][2,2]
        ...
        EPositiveFriendsPvalue  = myBoxplotResults[[2]][2,2]
        ENegativeFriendsAverage = myBoxplotResults[[3]][2,1]
        EPositiveFriendsAverage = myBoxplotResults[[3]][2,2]
